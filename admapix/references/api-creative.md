...
Search ad creatives across 5 content types. This data-layer skill always returns raw JSON — keep `generate_page` `false` (no H5 pages).
...
| generate_page | bool | false | Generate H5 result page — **keep false**; this skill returns raw data, not pages |
| delivery | object/null | null | H5 page context — leave null (not used by this data-layer skill) |
